            ...
            <div class="flex pt-14">
                ...
                <aside class="fixed left-0 top-14 bottom-0 w-60 bg-yt px-3 py-4 overflow-y-auto hidden lg:block">
                    <nav class="space-y-2">
                        ...
                        <a target="_blank" href="https://vinayislive.vercel.app" class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2"> <img class="rounded-full size-7" /> Vinay Kumar </a>
