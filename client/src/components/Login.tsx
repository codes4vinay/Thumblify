    ...
    return (
        <>
                ...
                >
                    ...
                    <button
                        ...
                        className={`mt-2 w-full h-11 rounded-full text-white transition flex items-center justify-center gap-2
                            ${loading ? "bg-cyan-400 cursor-not-allowed" : "bg-cyan-600 hover:bg-cyan-500"}
                        `}
                    >
                        {loading && (
                    ...
                    >
                        ...
                        <span className="text-cyan-400 hover:underline ml-1">
                            click here
                        </span>
                    </p>
                </form>
            ...
            {loading && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
                    <div className="flex flex-col items-center gap-3">
                        <div className="w-10 h-10 border-4 border-cyan-400/40 border-t-cyan-500 rounded-full animate-spin" />
            ...
            <div className="fixed inset-0 -z-1 pointer-events-none">
                <div className="absolute left-1/2 top-20 -translate-x-1/2 w-245 h-115 bg-linear-to-tr from-cyan-800/30 to-transparent rounded-full blur-3xl" />
                <div className="absolute right-12 bottom-10 w-105 h-55 bg-linear-to-bl from-teal-700/25 to-transparent rounded-full blur-2xl" />
            </div>
        </>
    );
};
