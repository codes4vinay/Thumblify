...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why use our generator?" text3="Create stunning thumbnails that gets clicks, without any hassle." />
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-4 mt-16 px-6">
                {featuresData.map((feature: IFeature, index: number) => (
                    <motion.div key={index} className={`${index === 1 ? 'p-px rounded-[13px] bg-linear-to-br from-cyan-500 to-slate-800' : ''}`}
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                <div className="absolute -z-50 size-100 -top-10 -left-20 aspect-square rounded-full bg-cyan-500/30 blur-3xl"></div>
                ...
                >
                    Our AI understands what makes a thumbnail click-worthy. It analyzes millions of high-performing thumbnails to make a video go viral.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <a href="https://prebuiltui.com" className="group flex items-center gap-2 mt-4 text-cyan-500 hover:text-cyan-400 transition">
